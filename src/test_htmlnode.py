...
class TestHTMLNode(unittest.TestCase):
    ...
    def test_props_eq(self):
        span_node = HTMLNode(
            "span", "the list of assert methods", None, {"class": "std std-ref"}
        )
        a_node = HTMLNode(
            "a",
            None,
        ...
        self.assertEqual(
            a_node.props_to_html(),
            ' class="reference internal" href="#assert-methods" target="_self"',
        )
